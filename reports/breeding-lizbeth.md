# Doe Breeding Report: Lizbeth (PD2292496)

**Doe Final Score:** `VEEG 85`  
**Lactation / appraisal context:** Lactation 2 (2026)  
...
**Pros (for this doe)**
- Estimated dairyness and rump-width transmitter — could reinforce her strengths
- Estimated capacity / mid–high-80s score package

**Cons / risks (for this doe)**
- Estimated Medial Suspensory Ligament only ~mid-20s and Teat Placement soft (~21) — not a top-priority mammary fixer (moderate–higher for her gaps)
- Unappraised ~5-month buck — high uncertainty (higher)

**Fit summary:** Possible width/dairy reinforcer later; not the primary pick for her MSL/teat gaps.

## Side-by-Side

| Priority trait | Lizbeth | Michael | Smithy | Finale (est.) |
|----------------|---------|---------|--------|---------------|
| Medial Suspensory Ligament | 13 | — (buck) | — (buck) | ~24–25 est. |
| Teat Placement | 17 | — | — | ~21 est. |
| Dairyness | 38 | 30 | 33 | strength est. |
| Rump Width | 31 | 28 | 24 | ~29–31 est. |
| Rump Angle | 23 | 34 | 28 | intermediate est. |
...
## Breeding Notes
- Outside genetics still warranted for Medial Suspensory Ligament and Teat Placement — no on-hand buck fully solves that.
- Lactation 2 already shows the mammary pattern clearly; don’t wait on “maturity” for MSL 13 / TP 17.
