...
- **Rump Width 31** — among the wider does; valuable both for score and as a buffer for her flatter Rump Angle.
...
4. **Rump Angle 23** — already on the flat side; further flattening is a functional risk (width mitigates somewhat).
...
3. Protect / reinforce Rump Width while seeking bucks that do not flatten Rump Angle further.
