...
3. **Rump Width 21** — narrowest doe; high-ROI and needed as angle buffer.
4. **Rump Angle 21** — flattest in the herd; further flattening is a higher functional risk. Manage via width/thurl, not by ignoring it.
...
3. Rump Width — trait gain plus mitigation for her flat Rump Angle.
4. Protect Rear Udder Height and dairyness while pursuing the above.

## Lower-Priority or Harder Traits
- Rump Angle as a direct selection target — relevant here mainly as a **risk to not worsen**; pair with width rather than chasing angle alone.
