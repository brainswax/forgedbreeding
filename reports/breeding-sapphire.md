# Doe Breeding Report: Sapphire (PD2380418)

**Doe Final Score:** `VEVV 88`  
**Lactation / appraisal context:** Lactation 1 (2026)  
...
**Pros (for this doe)**
- Estimated dairyness and width transmission could reinforce her best traits
- Estimated capacity / score package

**Cons / risks (for this doe)**
- Estimated soft Teat Placement and only middling MSL — weak against her top priorities (moderate–higher)
- Unappraised / very young (higher uncertainty)

**Fit summary:** Compatible dairy/width story on paper; not her mammary solution.

## Side-by-Side

| Priority trait | Sapphire | Michael | Smithy | Finale (est.) |
|----------------|----------|---------|--------|---------------|
| Medial Suspensory Ligament | 17 | — | — | ~24–25 est. |
| Teat Placement | 21 | — | — | ~21 est. |
| Dairyness | 40 | 30 | 33 | strength est. |
| Rump Width | 35 | 28 | 24 | ~29–31 est. |
| Rump Angle | 24 | 34 | 28 | intermediate est. |
...
## Breeding Notes
- First lactation — re-appraise before locking multi-year conclusions on teat/MSL numbers, but gaps are already large enough to act on directionally.
- Protect Rear Udder Height/Arch as low-heritability strengths when ranking future bucks.
