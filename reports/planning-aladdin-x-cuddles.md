...
**Mode:** Existing offspring analysis (retrospective accuracy test)

**Pair:**
- Sire: Cade's Lil Farm PR Aladdin (PD2076307) — unappraised; estimated transmitting profile (`estimated: yes`) from daughters + dam Sleepnbeauty
- Dam: GCH Cade's Lil Farm AX Cuddles (PD1869395) — permanent `VEEE 91` (2024-06-27, LCT 6)

**Offspring:** Cade's Lil Farm AL Tinkles (PD2434405) — `VVVA 84` (Lactation 1, 2026-07-26)

**Estimate inputs used for prediction:** Aladdin daughter midpoints from his estimated profile (DY ≈ 34, RW ≈ 30, RA ≈ 30.5, BD ≈ 35.5, STR ≈ 31, RLSV ≈ 27, UD ≈ 32, MSL ≈ 21.5, TP ≈ 21, TD ≈ 26 median, stature ≈ 28). Leave-one-out without Tinkles barely moves those midpoints — circularity is not material here.

---

## Parental / Pair Score Summary

| Trait | Cuddles (dam, PS) | Aladdin (sire, est.) | Planning midpoint / read |
|-------|-------------------|----------------------|--------------------------|
| **Final Score** | `VEEE 91` | mid-80s typical | High-80s ceiling if mammary holds; mid-80s more likely |
| Stature | 27 | ≈ **28** | ~27.5 expected |
| Body Depth | **40** | ≈ **35.5** | Midpoint ~37.5 — capacious expectation |
| Strength | 33 | ≈ **31** | Midpoint ~32 — solid strength expected |
| Dairyness | **35** | ≈ **34** | **Reinforced dairy** — clearest expected strength |
| Rump Angle | **29** (near preferred) | ≈ **30.5** (mean); flat outliers in book | Midpoint ~30 (preferred); **flat-RA right-of-bell-curve risk** from sire |
| Rump Width | **32** | ≈ **30** | Midpoint ~31 — expect usable–good width |
...
- **Dairyness (35 / ~34)** — both sides dairy; daughters should often read sharp. Primary expected win.
- **Final Score ceiling** — dam is `91`; Aladdin daughters reach 89–91. Package can be elite when mammary and angle cooperate.
- **Body Depth / capacity (40 / ~35.5)** — both capacious; keepers should not look tight.
- **Strength (33 / ~31)** — solid on both sides.
- **Rear Legs Side View (27 / ~27)** — intermediate set reinforced on average.
- **Attachments** — dam FA/RH/RUA mid-30s; Aladdin daughter averages ≈ 32 / 34 / 34. Expect adequate–good udder attachments more often than elite cleft/teats.
- **Rump Angle toward preferred (on average)** — dam 29 + sire mean ~30.5 favors **30–35** *if* the mean expresses rather than the flat right-of-bell-curve extreme.
...
- **Udder Depth** — sire daughter mean ~32 (deeper than dam 27); watch longevity if daughters land deep.
- **No sire own LA** — frame/mammary reads are progeny estimates (`ConfidencePenalty` if used in BIS).
...
- Mid-80s Final Score with a higher ceiling
- Capacious body depth and solid strength (parental mids ~37.5 / ~32)
- Intermediate rear-leg set (~27)
- Usable rump width near the parental mid (~30)
- Preferred-band rump angle *on average*

**Least likely to deliver (without hard selection)**
- Dam-like elite MSL (33) — sire mean pulls hard toward ~21–22
...
5. **Dairyness / depth / strength / FS** — expect these; use as tie-breakers only after mammary and angle.

### Bottom line (planning view)

Cuddles × Aladdin should produce **dairy, capacious, mid-to-high 80s daughters with usable width**, while **MSL, teat placement, and flat RA** are the traits that decide keep vs pass.

---

## Accuracy Audit — Planning vs Tinkles Actual

**Tinkles 2026 (LCT 1):** `VVVA 84` — ST 23, BD 36, STR 37, DY **36**, RA **38**, RW **25**, RLSV 26, FA 31, RH 28, RUA 31, MS **17**, UD 28, TP **20**, TD 24, TL 30.

### Numerical check (parental midpoint vs actual)

| Trait | Predicted mid | Tinkles | Error | Verdict |
|-------|---------------|---------|-------|---------|
| Dairyness | 34.5 | **36** | +1.5 | **Accurate** |
| Body Depth | ~37.5 | **36** | −1.5 | **Accurate** |
| Rear Legs Side View | ~27 | **26** | −1 | **Accurate** |
| Udder Depth | ~29.5 | **28** | −1.5 | **Accurate** |
| Strength | ~32 | **37** | +5 | **Directionally ok** (solid; stronger than mid) |
| Final Score | mid-80s (ceiling higher) | **84** | on band | **Accurate** |
...
**MAE on the four newly filled traits (BD, RLSV, UD, STR): ~2.2.**  
**MAE on prior problem set (stature, DY, RW, RA, MS, TP, TD): ~6.1** (stature mid corrected from the earlier strength/stature mix-up).

### Directional / narrative scorecard

| Planning claim | Outcome | |
|----------------|---------|---|
| Reinforced dairyness | DY 36 | **Hit** |
| Capacious depth | BD 36 | **Hit** |
| Intermediate RLSV | 26 | **Hit** |
...
Under the selection priorities above, Tinkles’ **RA 38, MS 17, TP 20, RW 25** are exactly the pass triggers. Her **DY 36 / STR 37 / BD 36 / FS 84** are real assets but do not override those. That matches how the planning report said to use this pedigree — so the **decision framework was more accurate than the midpoint forecast** on the high-risk traits.
