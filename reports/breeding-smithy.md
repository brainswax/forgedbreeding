# Buck Breeding Report: Smithy (PD2380421)

**Buck Final Score:** `VVE 86`  
**Appraisal / profile context:** Appraised 2026; young herd sire  
...
**Pros:** She brings width 31 — covers his narrowness somewhat; dairyness compatible; flattens less than Michael (28 vs 34).  
**Cons:** Still flattens her steep 23 without matching Michael’s overall package; RW 24 weakens her width buffer (moderate–higher).  
**Fit summary:** Mediocre; Michael is clearly better for her.

### Sapphire (PD2380418) — `VEVV 88`
**Pros:** She brings width 35 and dairyness 40 — best cover for his RW 24; he can add strength vs her 29; less flattening than Michael.  
...
**Pros:** None specific.  
**Cons:** Blind narrow-rump risk (higher uncertainty).  
**Fit summary:** Deprioritize until scored.

## Side-by-Side

| Trait | Smithy | Lizbeth | Sapphire | Snickers | Amber | Tinkles | Lux |
|-------|--------|---------|----------|----------|-------|---------|-----|
| Final Score | `VVE 86` | `VEEG 85` | `VEVV 88` | `GAEV 84` | `GEEV 86` | `VVVA 84` | NA |
| Rump Angle | 28 | 23 | 24 | 36* | 21 | 38* | ? |
| Rump Width | 24 | 31 | 35 | 23 | 21 | 25 | ? |
...
**Runner-up:** Lizbeth — only if Michael is unavailable; accept flattening of her steep angle with weaker width synergy than Michael.
...
- **Assessment:** Conditional — limited role
