# Doe Breeding Report: Lux (PD2292494)
...
3. Avoid stacking known herd-wide risks blindly (soft MSL/teats, narrow rumps)
...
- Mammary transmitting unmeasured (moderate)
...
**Cons / risks (for this doe)**
- Narrow Rump Width (24) is a known herd liability to avoid stacking blindly (moderate–higher)
- Without her scores, cannot tell if she already brings width (higher uncertainty)
...
**Cons / risks (for this doe)**
- Double uncertainty: her unknown LA + his estimate/youth (higher)
- Estimated soft teats / middling MSL may stack with herd pattern (moderate–higher)

**Fit summary:** Too much stacked uncertainty for a primary pick.
...
| Dairyness | ? | 30 | 33 | strength est. |
| Medial Suspensory Ligament | ? | — | — | ~24–25 est. |
...
## Breeding Notes
- Incomplete LA is the binding constraint — this report cannot optimize GOALS.md mammary priorities for her specifically.
- Shared Sleepnstag sire with Lizbeth is pedigree context only; do not infer Lux’s scores from Lizbeth.
